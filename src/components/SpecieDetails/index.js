                ...
                <div className="card-infos">
                    <div className="card-header">
                        ...
                        <span className="card-additional">
                            <p>{context.dataSelected.data[0].language}</p>
                            <p>{context.dataSelected.data[0].classification}</p>
                            <p>{context.dataSelected.data[0].designation}</p>
                        </span>
                    </div>
                    ...
                    <div className="card-body">
                        ...
                        {context.dataSelected.data[0].people.length > 0 &&
                        <CardList data={context.dataSelected.data[0].people} title={'People'} />}
                    </div>
                </div>
            </div>
        )}
